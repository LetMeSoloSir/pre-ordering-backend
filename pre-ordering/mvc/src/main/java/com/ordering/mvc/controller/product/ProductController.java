...
public class ProductController {
    ...
    @PostMapping("/detail")
    public ResponseEntity<ApiResponse<ProductDetailResponse>> getProductById(@RequestBody ProductDetailRequest request){
        ProductDetailResponse response = productDetailService.doProcess(request);
//        productRecentViewService.add(user.getId(), id);
...
//        List<ProductResponse> productPage= productRecentGetService.doProcess(user.getId());
